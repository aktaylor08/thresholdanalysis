...
mapping = {
    ...
    "Airbotix runtime package": ["Airbotix runtime package", ],
    ...
    "runtime filter library": ["runtime filter library", ],
    "graft": ["graft", ],
    ...
    "People tracking runtime": ["People tracking runtime"],
    ...
    "runtime universial robot": ["runtime universial robot ", ],
